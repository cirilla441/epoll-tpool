...
int send_friend_req(int sockfd)//发送好友请求
{
	...
	scanf("%d",&frd_pk.send_id2);
	frd_pk.send_id1 = temp_data0.current_id1;
	memcpy(frd_pk.sourse_name,temp_data0.current_name,strlen(temp_data0.current_name));
	//fflush(stdin);
